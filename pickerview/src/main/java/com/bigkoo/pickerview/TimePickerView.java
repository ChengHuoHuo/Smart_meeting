...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    public static class Builder {
         ...
         * 精确到天
         */
        public Builder setTime(String label_year, String label_month, String label_day) {
            this.label_year = label_year;
            this.label_month = label_month;
            this.label_day = label_day;
//            this.label_hours = label_hours;
//            this.label_mins = label_mins;
         ...
         * 精确到月
         */
        public Builder setTimeM(String label_year, String label_month) {
            this.label_year = label_year;
            this.label_month = label_month;
//            this.label_day = label_day;
//            this.label_hours = label_hours;
//            this.label_mins = label_mins;
         ...
         * 精确到分
         */
        public Builder setTimes(String label_year, String label_month, String label_day,String label_hours, String label_mins) {
            this.label_year = label_year;
            this.label_month = label_month;
            this.label_day = label_day;
            this.label_hours = label_hours;
